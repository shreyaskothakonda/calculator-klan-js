// Get all the form input wrappers
const formInputWrappers = document.querySelectorAll(
  '[calc-element="input-wrapper"]'
);

// Function to mirror initial value, min, and max attributes to input
...
// Call the mirrorAttributes function for each form input wrapper
